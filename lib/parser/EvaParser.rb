...
[3,0,'_handler9']]
  ...
  def self._handler1(_1)
YYParse.__ = _1
end

def self._handler2(_1)
YYParse.__ = _1
end

def self._handler3(_1)
YYParse.__ = _1
end

def self._handler4(_1)
 YYParse.__ = string_to_number(_1) 
end

def self._handler5(_1)
YYParse.__ = _1
end

def self._handler6(_1)
YYParse.__ = _1
end

def self._handler7(_1,_2,_3)
 YYParse.__ = _2 
end

def self._handler8(_1,_2)
 _1.push(_2); YYParse.__ = _1 
end
...
[/\A\d+/, '_lex_rule5'],
[/\A[\w\-+*=<>\/]+/, '_lex_rule6']]
  @@lex_rules_by_conditions = {'INITIAL' => [0, 1, 2, 3, 4, 5]}
